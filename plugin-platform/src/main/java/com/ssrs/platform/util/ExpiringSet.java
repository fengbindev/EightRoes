...
public class ExpiringSet<E> extends AbstractSet<E> {
	...
	public ExpiringSet(int timeToLive, int expirationInterval) {
		this(new ConcurrentHashMap<E, ExpiringObject>(), timeToLive, expirationInterval, false);
	}

	public ExpiringSet(int timeToLive, int expirationInterval, boolean start) {
		this(new ConcurrentHashMap<E, ExpiringObject>(), timeToLive, expirationInterval, start);
	}

	private ExpiringSet(ConcurrentHashMap<E, ExpiringObject> delegate, int timeToLive, int expirationInterval, boolean start) {
		this.m = delegate;
